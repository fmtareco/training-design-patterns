...
# Proxy
* Complexity: Medium
* Description: Provides a substitute or placeholder for another object. 
	* A proxy controls access to the original object, allowing you to perform something either before or after the request reaches the original object (e.g., logging or caching).
---
